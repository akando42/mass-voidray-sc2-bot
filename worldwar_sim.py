...
def parse_arguments():
    ...
    parser.add_argument("--Industry", type=str, help="Industry Production Position")
    parser.add_argument("--Defense", type=str, help="Defensive Structure Position")
    parser.add_argument("--Offense", type=str, help="Offensive Unit Position")
    
    parser.add_argument("--Final", type=str, help="Enemy Main Base")
